...
public class BroadcastUtils {
    ...
    public static final String LOGIN_INVALID_ACTION = "westcoast.oyo.login_invalid_action";

    public static final String UMENG_MESSAGE_REGISTRATIONID = "westcoast.oyo.umeng_message_registrationid";
